...
@click.option(
    "--verbose", "-v", is_flag=True, default=False, help="Display log output to console"
)
@click.option(
    "--admin", is_flag=True, default=False, help="Enable admin actions", hidden=True
)
...
def cert_save(ctx, name):
    ...
    if certificate.isValid():
        ...
        logger.error(
            f"{certificate.name} is invalid. Check validity Dates:\n {certificate.info()}"
        )
        sys.exit(2)
