...
def from_address(text, v4_origin=ipv4_reverse_domain, v6_origin=ipv6_reverse_domain):
...
def to_address(name, v4_origin=ipv4_reverse_domain, v6_origin=ipv6_reverse_domain):
