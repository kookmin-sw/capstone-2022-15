...
if False:
    ...
    from .compat import StreamTextType, StreamType, VersionType
__all__ = [
    "CBaseLoader",
    "CSafeLoader",
    "CLoader",
...
class CBaseLoader(CParser, BaseConstructor, BaseResolver):
    def __init__(A, stream, version=_A, preserve_quotes=_A):
        ...
        BaseResolver.__init__(A, loadumper=A)
...
class CBaseDumper(CEmitter, BaseRepresenter, BaseResolver):
    def __init__(
        ...
        A._emitter = A._serializer = A._representer = A
...
class CSafeDumper(CEmitter, SafeRepresenter, Resolver):
    def __init__(
        ...
        SafeRepresenter.__init__(
            A, default_style=default_style, default_flow_style=default_flow_style
        )
        Resolver.__init__(A)
