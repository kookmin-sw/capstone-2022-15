...
class GreenSSLSocket(_original_sslsocket):
    ...
    def write(self, data):
        ...
        return self._call_trampolining(super(GreenSSLSocket, self).write, data)
        ...
        if self._sslobj:
            if flags != 0:
                raise ValueError(
                    ...
                    % plain_socket_function.__name__,
                    self.__class__,
                )
            if into:
    ...
    def unwrap(self):
        return GreenSocket(self._call_trampolining(super(GreenSSLSocket, self).unwrap))

    def do_handshake(self):
        """Perform a TLS/SSL handshake."""
        return self._call_trampolining(super(GreenSSLSocket, self).do_handshake)
    ...
    def connect(self, addr):
        ...
        try:
            ...
            if six.PY2:
                sslobj = self._context._wrap_socket(
                    self._sock, server_side, ssl_sock=self
                )
            else:
                context = self.context if PY33 else self._context
                sslobj = context._wrap_socket(
                    self, server_side, server_hostname=self.server_hostname
                )
        else:
            sslobj = sslwrap(
                self._sock,
    ...
    class GreenSSLContext(_original_sslcontext):
        ...
        if hasattr(_original_sslcontext.options, "setter"):
            ...
            def options(self, value):
                super(_original_sslcontext, _original_sslcontext).options.__set__(
                    self, value
                )

            @_original_sslcontext.verify_flags.setter
            def verify_flags(self, value):
                super(_original_sslcontext, _original_sslcontext).verify_flags.__set__(
                    self, value
                )

            @_original_sslcontext.verify_mode.setter
            def verify_mode(self, value):
                super(_original_sslcontext, _original_sslcontext).verify_mode.__set__(
                    self, value
                )
            ...
            if hasattr(_original_sslcontext, "maximum_version"):
                ...
                def maximum_version(self, value):
                    super(
                        _original_sslcontext, _original_sslcontext
                    ).maximum_version.__set__(self, value)
            ...
            if hasattr(_original_sslcontext, "minimum_version"):
                ...
                def minimum_version(self, value):
                    super(
                        _original_sslcontext, _original_sslcontext
                    ).minimum_version.__set__(self, value)
