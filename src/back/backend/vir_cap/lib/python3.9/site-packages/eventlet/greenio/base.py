    ...
    try:
        ...
        try:
            ...
            raise NotImplementedError(
                "set_nonblocking() on a file object "
...
class GreenSocket(object):
    ...
    def accept(self):
        ...
        while True:
            ...
            self._trampoline(
                fd, read=True, timeout=self.gettimeout(), timeout_exc=_timeout_exc
            )
    ...
    def connect(self, address):
        ...
        if self.gettimeout() is None:
            ...
            while True:
                ...
                try:
                    self._trampoline(
                        fd, write=True, timeout=timeout, timeout_exc=_timeout_exc
                    )
                except IOClosed:
    ...
    def makeGreenFile(self, *args, **kw):
        warnings.warn(
            "makeGreenFile has been deprecated, please use " "makefile instead",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _send_loop(self, send_method, data, *args):
        ...
        while True:
            ...
            try:
                ...
                raise socket.error(
                    errno.ECONNRESET, "Connection closed by another thread"
                )
