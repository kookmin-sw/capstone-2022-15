...
if six.PY2:
    ...
    URLopener.open_http = patcher.patch_function(
        URLopener.open_http, ("httplib", httplib)
    )
    if hasattr(URLopener, "open_https"):
        URLopener.open_https = patcher.patch_function(
            URLopener.open_https, ("httplib", httplib)
        )
    ...
    ftpwrapper.retrfile = patcher.patch_function(
        ftpwrapper.retrfile, ("ftplib", ftplib)
    )
